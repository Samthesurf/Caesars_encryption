...
def caesar(cipher_direction, plaintext, shift_amount):
  ...
  for char in plaintext:
    ...
    if char not in alphabet:
      ...
      letter_in_list  # The goalhere was too use my mistake from when I was prime checking, I saw Angela's answer and was frustrated
      # but this exercise of accounting for spaces and symbols helped me realize and recall my mistakes to solve it.
      position = alphabet.index(char)
      actual_shift = shift_amount % len(alphabet) # in case the number is too large
